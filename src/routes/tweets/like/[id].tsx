...
export const get = async (context: Context) => {
  ...
  try {
    const likeCount = await db
      ...
      .from(tweetLikes)
      .where(eq(tweetLikes.tweetId, id))
      .limit(1);
  ...
  try {
    ...
    if (liked.length > 0) {
      return <Button liked={true} id={id} count={count} />;
    }
    return <Button liked={false} id={id} count={count} />;
  } catch (e) {
    console.log(e);
...
export const post = async (context: Context) => {
  ...
  try {
    ...
    return <Button liked={true} id={id} count={count + 1} />;
  } catch (e) {
    console.log(e);
    return <Button liked={false} id={id} count={count} />;
  }
...
export const del = async (context: Context) => {
  ...
  try {
    ...
    return <Button liked={false} id={id} count={count - 1} />;
  } catch (e) {
    console.log(e);
    return <Button liked={true} id={id} count={count} />;
  }
